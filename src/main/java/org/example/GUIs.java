...
public class GUIs { // Sorted by order of execution
    ...
    public static int confirmPopUp(String text, String title){
    ...
    public static String pullDownMenu(String text,String title,String[] options){ return (String)JOptionPane.showInputDialog(null,text,title,0,null,options,"Yes!");}
}
